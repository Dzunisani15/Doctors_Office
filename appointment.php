...
$patient_name = $contact_number = $email = $appointment_date = $appointment_time = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO appointments (patient_name, contact_number, email, appointment_date, appointment_time) VALUES ($1, $2, $3, $4, $5)";
    $result = pg_query_params($conn, $query, array($patient_name, $contact_number, $email, $appointment_date, $appointment_time));
    pg_close($conn);
}
?>
